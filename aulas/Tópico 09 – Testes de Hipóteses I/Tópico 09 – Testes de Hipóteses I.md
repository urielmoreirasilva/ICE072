---
layout: default
title: "Tópico 09 – Testes de Hipóteses I"
parent: "Aulas"
nav_order: 9
---
# Tópico 09 – Testes de Hipóteses I [<img src="https://raw.githubusercontent.com/urielmoreirasilva/ICE072/main/aulas/T%C3%B3pico%2009%20%E2%80%93%20Testes%20de%20Hip%C3%B3teses%20I/images/colag_logo.svg" style="float: right; margin-right: 0%; vertical-align: middle; width: 6.5%;">](https://colab.research.google.com/github/urielmoreirasilva/ICE072/blob/main/aulas/T%C3%B3pico%2009%20%E2%80%93%20Testes%20de%20Hip%C3%B3teses%20I/T%C3%B3pico%2009%20%E2%80%93%20Testes%20de%20Hip%C3%B3teses%20I.ipynb) [<img src="https://raw.githubusercontent.com/urielmoreirasilva/ICE072/main/aulas/T%C3%B3pico%2009%20%E2%80%93%20Testes%20de%20Hip%C3%B3teses%20I/images/github_logo.svg" style="float: right; margin-right: 0%; vertical-align: middle; width: 3.25%;">](https://github.com/urielmoreirasilva/ICE072/blob/main/aulas/T%C3%B3pico%2009%20%E2%80%93%20Testes%20de%20Hip%C3%B3teses%20I/T%C3%B3pico%2009%20%E2%80%93%20Testes%20de%20Hip%C3%B3teses%20I.ipynb)
...
```python
flips_400 = pd.read_csv('https://raw.githubusercontent.com/urielmoreirasilva/ICE072/main/aulas/T%C3%B3pico%2009%20%E2%80%93%20Testes%20de%20Hip%C3%B3teses%20I/data/flips-400.csv')
flips_400
```
...
```
    ...
    (np.float64(180.0), np.float64(220.0))
...
```
    ...
    array([193., 194., 202., ..., 201., 201., 192.], shape=(10000,))
...
![png](T%C3%B3pico%2009%20%E2%80%93%20Testes%20de%20Hip%C3%B3teses%20I_files/T%C3%B3pico%2009%20%E2%80%93%20Testes%20de%20Hip%C3%B3teses%20I_68_0.png)
...
```
    ...
    (np.float64(168.0), np.float64(208.0))
...
```
    ...
    [np.float64(0.42), np.float64(0.52)]
...
```
    ...
    [np.float64(169.0), np.float64(207.0)]
...
```
    ...
    [np.float64(0.4225), np.float64(0.5175)]
...
```
    ...
    np.float64(0.055099999999999996)
